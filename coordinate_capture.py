...
from qgis.core import QgsUnitTypes, QgsCoordinateTransform, QgsCoordinateReferenceSystem, QgsPointXY, QgsApplication
...
class CoordinateCapture:
    ...
    def update(self, point: QgsPointXY):
        ...
        if self.dockwidget.userCrsEdit.text().isEmpty():
            if self.dockwidget.userCrsEdit1.text().isEmpty() :
               userCrsPoint2 = self.transform.transform(point)
